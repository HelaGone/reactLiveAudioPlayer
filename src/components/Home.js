				...
				<section className="section_wrapper">
					...
					<div className="bottom_wrapper">
						...
						<ul className="signal_switch">
							<li className="signal_item">
								<button class={isLive ? 'signal_selected' : ''} onClick={ () => playback("http://s2.voscast.com:8162/;&type=mp3", true) }>EN VIVO</button>
							</li>
							<li className="signal_item">
								<button class={isLive ? '' : 'signal_selected'} onClick={ () => playback("https://example.com", false) } >ARCHIVO</button>
							</li>
						</ul>
